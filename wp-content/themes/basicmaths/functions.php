...
function basic_404_link() {
	...
	if($bm_archives_link == '') {
		echo '<p>' . __('Still can’t find what you’re looking for? ', 'basicmaths') . ' <a href="mailto:' . antispambot(get_bloginfo('admin_email')) . '">' . __( 'Email the team at Baum', 'basicmaths' ) . '</a>.' . __( '', 'basicmaths' ) . '</p>';

	} else {
		echo '<p>' . __( 'Still can’t find what you’re looking for? Try ', 'basicmaths' ) . '<a href="' . get_bloginfo ( 'url' ) . '/' . $bm_archives_link . '">' . __( 'browsing the archives', 'basicmaths' ) . '</a>, ' . __( 'or you can', 'basicmaths' ) . ' <a href="mailto:' . antispambot(get_bloginfo('admin_email')) . '">' . __( 'Email the team at Baum', 'basicmaths' ) . '</a>.' . __( '', 'basicmaths' ) . '</p>';
...
function basic_maths_js() { ?>
	...
	<script langiage="javascript" type="text/javascript" src="<?php echo bloginfo('stylesheet_directory') ?>/js/jquery.hoverIntent.js"></script>
	<script langiage="javascript" type="text/javascript" src="<?php echo bloginfo('stylesheet_directory') ?>/js/jquery.parser.js"></script>
